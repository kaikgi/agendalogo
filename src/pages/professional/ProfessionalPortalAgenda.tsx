...
import { ChevronLeft, ChevronRight, Clock, User, CalendarDays, List, LogOut, Loader2, Settings } from 'lucide-react';
...
export default function ProfessionalPortalAgenda() {
  ...
  // Fetch current professional data for photo
  ...
  const handleProfileUpdated = () => {
    // Invalidate session to refresh name
        ...
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as TabMode)}>
          ...
          <TabsContent value="profile">
            <ProfessionalProfileSection
              ...
              currentPhotoUrl={professionalData?.photo_url}
