...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center pt-16">
      ...
      {/* Gradient orb */}
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-muted rounded-full blur-3xl opacity-60" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative animate-fade-in" style={{ animationDelay: "0.2s" }}>
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 bg-card rounded-xl border border-border shadow-elegant p-4 animate-float">
